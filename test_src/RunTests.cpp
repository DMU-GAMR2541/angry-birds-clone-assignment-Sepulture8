...
protected:
    ...
    void SetUp() override {
        // Code here will be called immediately after the constructor (right
        // before each test).
        slingshot = std::make_unique<Slingshot>(100, "Red"); // All enemnies in this test suite start with 50 HP.
...
TEST_F(SlingShotTest, Test_Bird_Colour) {
